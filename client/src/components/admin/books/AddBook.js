...
import * as services from "../../../services/booksService";
        ...
        .then((response) => {
          ...
          this.state.categories.forEach(element => {
            if (element._id === response.data.data.categories[0]) {
              let obj = {
                label: element.label, _id: response.data.data.categories[0]
              }
